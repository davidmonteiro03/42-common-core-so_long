...
#    Updated: 2025/09/18 14:32:38 by dcaetano         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SLSRCS    = ./srcs/mandatory/errors/so_long_error.c \
            ...
            ./srcs/mandatory/utils/free.c ./srcs/mandatory/utils/readfile.c \
            ./srcs/mandatory/utils/strcmp.c ./srcs/mandatory/utils/mapdup.c \
...
SLSRCS_B  = ./srcs/bonus/errors/so_long_error.c \
            ...
            ./srcs/bonus/exit/so_long_exit.c ./srcs/bonus/free/so_long_free.c \
            ...
            ./srcs/bonus/utils/free.c ./srcs/bonus/utils/readfile.c \
            ./srcs/bonus/utils/strcmp.c ./srcs/bonus/utils/mapdup.c \
            ./srcs/bonus/utils/getvalues.c ./srcs/bonus/utils/joinfree.c \
            ./srcs/bonus/utils/enemies.c \
            ./srcs/bonus/utils/generateposition.c \
            ./srcs/bonus/utils/removenode.c ./srcs/bonus/utils/findnode.c \
            ./srcs/bonus/utils/ptrinptrs.c ./srcs/bonus/utils/wrongfree.c \
            ./srcs/bonus/utils/fireballs.c ./srcs/bonus/utils/istransp.c \
